                ...
                <div id="kt_app_content_container" class="app-container container-xxl px-0">
                    <div class="d-flex flex-grow gap-6 flex-column flex-md-row mb-8">
                        ...
                        <div class="d-flex gap-4">
                            <Link :href="`/admin/${product.slug}/${subProduct.slug}/playlists/${playlist.id_playlist}/edit`"
                                class="w-100 w-md-auto btn btn-sm btn-mysecondary fs-5 align-self-end white-space-nowrap">
                                Edit Playlist
                            </Link>
                            <Link :href="`/admin/${product.slug}/${subProduct.slug}/playlists/${playlist.id_playlist}/videos/create`"
                        ...
                        <div class="col-md-8">
                            <div class="d-flex flex-column gap-4">
                                ...
                                <Link v-else v-for="(playlist_video, index) in playlist.playlist_videos" :key="index"
                                    :href="`/admin/${product.slug}/${subProduct.slug}/playlists/${playlist.id_playlist}/videos/${playlist_video.id_video}`"  
