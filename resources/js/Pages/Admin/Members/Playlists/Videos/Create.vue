<template>
    ...
    <Head>
        <title>Tambah Playlist − {{ product.title }}</title>
    </Head>
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3 text-muted">Tambah Video</li>
                        </ol>
                        <div class="page-heading d-flex flex-wrap gap-3 align-items-center">
                            <h1 class="mb-0 text-dark">Tambah Video</h1>
                ...
                <div id="kt_app_content_container" class="app-container container-xxl px-0">
                    <form @submit.prevent="submit">
                        ...
                        <div class="d-flex justify-content-end mt-7">
                            <Link :href="`/admin/${product.slug}/${subProduct.slug}/playlists`"
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                router.post(`/admin/${props.product.slug}/${props.subProduct.slug}/playlists/${props.playlist.id_playlist}/videos`, payload, {
                    onSuccess: () => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
