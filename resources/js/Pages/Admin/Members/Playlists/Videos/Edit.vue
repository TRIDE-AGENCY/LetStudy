                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3 text-muted">Edit Video</li>
                        </ol>
                        <div class="page-heading d-flex flex-wrap gap-3 align-items-center">
                            <h1 class="mb-0 text-dark">Edit Video</h1>
                    ...
                    <form @submit.prevent="submit">
                        <div class="row g-6">
                                    ...
                                    <div class="card-body p-6">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <textarea class="form-control fs-5" data-kt-autosize="true" rows="5"
                                                placeholder="Masukkan nama video disini..." v-model="form.title"
                                        ...
                                        <div class="fv-row">
                                            <label class="required form-label fs-6">ID Video</label>
                                            <input type="text" class="form-control fs-5" v-model="form.id_video"
                                                required placeholder="Masukkan ID video youtube disini..."
                                                :class="{ 'is-invalid': errors.id_video }" />
                                            <div v-if="errors.id_video" class="text-mydanger mt-2">
                                                {{ errors . id_video }}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-8">
                                <div class="card rounded-4 border border-gray-300">
                                    <div class="card-header p-6 d-flex flex-column m-0 border-bottom border-gray-300" style="min-height: unset;">
                                        <h3 class="required mb-0">Thumbnail Video</h3>
                                    </div>
                                    <div class="card-body p-6">
                                        <div id="video-dropzone" class="dropzone border-dashed border-myprimary rounded p-5 text-center">
                                ...
                                <div class="card rounded-4 border border-gray-300 mt-6">
                                    <div class="card-header p-6 d-flex flex-column m-0 border-bottom border-gray-300" style="min-height: unset;">
                                        <h3 class="mb-0">Deskripsi Video</h3>
                                    </div>
                                    <div class="card-body p-6">
                                        <div class="fv-row">
                                            <Editor 
                        ...
                        <div class="d-flex justify-content-end mt-7">
                            <button @click.prevent="destroy(playlistVideo.id_video)"
...
<script>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                title: props.playlistVideo.title,
                id_video: props.playlistVideo.id_video,
                thumbnaill: null,
                description: props.playlistVideo.description ?? '',
            });
            ...
            onMounted(() => {
                const dz = new Dropzone('#video-dropzone', {
                    url: '/', 
                    paramName: 'thumbnail',
                    maxFiles: 1,
                    maxFilesize: 10,
                    ...
                    init: function () {
                        ...
                        if (props.playlistVideo.thumbnail) {
                            const mockFile = {
                                name: props.playlistVideo.thumbnail_name ?? 'Thumbnail Video',
                                size: props.playlistVideo.thumbnail_size ?? 12345
                            };
                            this.emit('addedfile', mockFile);
                            this.emit('thumbnail', mockFile, `/storage/${props.playlistVideo.thumbnail}`);
            ...
            const submit = () => {
                ...
                payload.append('id_video', form.id_video);
                ...
                router.post(`/admin/${props.product.slug}/${props.subProduct.slug}/playlists/${props.playlist.id_playlist}/videos/${props.playlistVideo.id_video}`, payload, {
                    onSuccess: () => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Data Video Berhasil Disimpan!',
                            timer: 2000,
            ...
            const destroy = (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(`/admin/${props.product.slug}/${props.subProduct.slug}/playlists/${props.playlist.id_playlist}/videos/${props.playlistVideo.id_video}`);
                        Swal.fire({
                            icon: 'success',
                            title: 'Dihapus!',
