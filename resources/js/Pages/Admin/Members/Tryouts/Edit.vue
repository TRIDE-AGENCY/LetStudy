                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3 text-muted">Edit Tryout</li>
                        </ol>
                        <div class="page-heading d-flex flex-wrap gap-3 align-items-center">
                            <h1 class="mb-0 text-dark">Edit Tryout</h1>
                ...
                <div id="kt_app_content_container" class="app-container container-xxl px-0">
                    <form @submit.prevent="submit">
                        ...
                        <div class="d-flex justify-content-end mt-7">
                            <button @click.prevent="destroy(tryout.slug)"
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                instruction: props.tryout.instruction ?? '',
                duration: props.tryout.duration,
                start_time: props.tryout.start_time ?? '',
                end_time: props.tryout.end_time ?? '',
                is_random_question: props.tryout.is_random_question === 1 || props.tryout.is_random_question === true,
                is_random_answer: props.tryout.is_random_answer === 1 || props.tryout.is_random_answer === true,
            ...
            const submit = () => {
                ...
                router.post(`/admin/${props.product.slug}/${props.subProduct.slug}/tryouts/${props.tryout.slug}`, payload, {
                    onSuccess: () => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Data Tryout Berhasil Diperbarui!',
                            timer: 2000,
                            timerProgressBar: true,
                            showConfirmButton: false,
                            customClass: {
            ...
            const destroy = (slug) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(`/admin/${props.product.slug}/${props.subProduct.slug}/tryouts/${props.tryout.slug}`);
                        Swal.fire({
                            icon: 'success',
                            title: 'Dihapus!',
