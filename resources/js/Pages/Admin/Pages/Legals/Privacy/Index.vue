<template>
    ...
    <Head>
        <title>Halaman Kebijakan Privasi − LetStudy</title>
    </Head>
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3 text-muted">Kebijakan Privasi</li>
                        </ol>
                        <div class="page-heading">
                            <h1 class="mb-0 text-dark">Halaman Kebijakan Privasi</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form @submit.prevent="submit">
                        <div class="card rounded-4 border border-gray-300">
                            <div class="card-header p-6 d-flex flex-column m-0 border-bottom border-gray-300" style="min-height: unset;">
                                <h3 class="required mb-0">Konten Kebijakan Privasi</h3>
                            </div>
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                router.put(`/admin/pages/legal/privacy-policy/${props.legal.id}`, {
                    ...
                    onSuccess: () => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Data Kebijakan Privasi Berhasil Diperbarui!',
                            timer: 2000,
