<template>
    ...
    <Head>
        <title>Section Banner − LetStudy</title>
    </Head>
                ...
                <div id="kt_app_content_container" class="app-container container-xxl px-0">
                    <div class="card rounded-4 border border-gray-300">
                            ...
                            <div class="flex-grow-1 ">
                                <form @submit.prevent="handleSearch"
                                    ...
                                    <input type="text" class="form-control form-control-solid ps-13 fs-5"
                                        placeholder="Cari heading banner disini..." v-model="search" />
                                </form>
                            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="text-center border-top border-bottom border-gray-300 py-10 px-6" v-if="banners.data.length === 0">
                                <img src="/assets/media/illustrations/empty.png"
                                    alt="Tidak ada data" class="mh-225px img-fluid mb-10">
                                <h2 class="text-dark mb-4">Banner Tidak Ditemukan</h2>
                                <p class="text-gray-600 fs-4 mb-0">Belum ada banner atau pencarian tidak sesuai.</p>
                            </div>
                                ...
                                <table id="kt_datatable_horizontal_scroll"
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="bg-secondary min-w-150px" style="letter-spacing: 0.04em;">E-Book</th>
                                            <th class="bg-secondary min-w-200px" style="letter-spacing: 0.04em;">Heading</th>
                                            <th class="bg-secondary min-w-300px" style="letter-spacing: 0.04em;">Sub Heading</th>
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr v-for="(banner, index) in banners.data" :key="index">
                                            <td class="ps-6">
                                                {{ ++index + (banners . current_page - 1) * banners . per_page }}
                                            </td>
                                            <td class="text-dark fw-bold mw-150px">
                                            ...
                                            <td class="text-end pe-6">
                                                ...
                                                <button @click.prevent="destroy(banner.id)"
                            ...
                            <Pagination :links="banners.links" align="end" class="py-5 px-6" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card w-100 rounded-0">
                    <div class="card-header ps-6 pe-3 h-60px border-bottom border-gray-300 h-60px h-lg-70px">
                        <div class="card-title">
                            <h2>{{ isEditMode ? 'Edit Banner' : 'Tambah Banner' }}</h2>
                        </div>
                        ...
                        <div class="flex-grow-1">
                            <div class="card rounded-4 border border-gray-300">
                                ...
                                <div class="card-body p-6">
                                    <div class="mb-5 fv-row">
                                        ...
                                        <select class="form-select form-control" required v-model="form.ebook_id" :class="{ 'is-invalid': errors.ebook_id }">
                                    ...
                                    <div class="mb-5 fv-row">
                                        ...
                                        <textarea class="form-control fs-5" data-kt-autosize="true" rows="5" required
                                            placeholder="Masukkan sub heading disini..." v-model="form.heading"
                            ...
                            <div class="card rounded-4 border border-gray-300 mt-6">
                                <div class="card-header h-auto p-6 border-bottom border-gray-300"
                                    style="min-height: unset;">
                                    <div class="card-title m-0">
                                        <h3 class="required">Gambar Banner</h3>
                                    </div>
                                </div>
                                <div class="card-body p-6">
                                    <div class="fv-row">
                                        <div id="banner-dropzone" :key="dropzoneKey"
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const handleSearch = () => {
                router.get("/admin/pages/letstudy/banners", {
                    q: search.value,
                });
            }
            ...
            const submit = () => {
                ...
                if (isEditMode.value && editing.value) {
                    ...
                    router.post(`/admin/pages/letstudy/banners/${editing.value.id}`, payload, {
                        onSuccess: () => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil!',
                    ...
                    router.post('/admin/pages/letstudy/banners', payload, {
                        onSuccess: () => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil!',
                                text: 'Data Banner Berhasil Disimpan!',
                                timer: 2000,
                                timerProgressBar: true,
                                showConfirmButton: false,
                                customClass: {
            ...
            const editBanner = (banner) => {
                ...
                form.ebook_id = banner.ebook_id;
                form.heading = banner.heading;
                form.sub_heading = banner.sub_heading;
                form.image = null;
            ...
            const destroy = (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(`/admin/pages/letstudy/banners/${id}`);
                        Swal.fire({
                            icon: 'success',
                            title: 'Dihapus!',
                ...
                nextTick(() => {
                    const dz = new Dropzone('#banner-dropzone', {
                        ...
                        init: function() {
                            ...
                            if (isEditMode.value && editing.value?.image) {
                                const mockFile = {
                                    name: editing.value.image.split('/').pop(),
                                };
                                this.emit('addedfile', mockFile);
                                this.emit('thumbnail', mockFile, `/storage/${editing.value.image}`);
