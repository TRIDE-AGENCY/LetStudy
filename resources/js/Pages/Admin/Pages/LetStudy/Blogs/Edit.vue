<template>
    ...
    <Head>
        <title>Edit Blog − LetStudy</title>
    </Head>
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3">
                                <Link href="/admin/pages/letstudy/blogs" class="btn-link-myprimary fw-bold pe-3">Blog</Link>
                            </li>
                            <li class="breadcrumb-item pe-3 text-muted">Edit Blog</li>
                        </ol>
                    ...
                    <form @submit.prevent="submit">
                        <div class="row g-6">
                                ...
                                <div class="card rounded-4 border border-gray-300">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <select class="form-select form-control" v-model="form.sub_product_id" :class="{ 'is-invalid': errors.sub_product_id }">
                            ...
                            <div class="col-md-8">
                                <div class="card rounded-4 border border-gray-300">
                                    <div class="card-header p-6 d-flex flex-column m-0 border-bottom border-gray-300" style="min-height: unset;">
                                        <h3 class="required mb-0">Konten Blog</h3>
                                    </div>
                                    <div class="card-body p-6">
                                        <div class="fv-row">
                                            <Editor 
                                ...
                                <div class="card rounded-4 border border-gray-300 mt-6">
                                    <div class="card-header p-6 d-flex flex-column m-0 border-bottom border-gray-300" style="min-height: unset;">
                                        <h3 class="required mb-0">Gambar Blog</h3>
                                    </div>
                                    <div class="card-body p-6">
                                        <div id="blog-dropzone" class="dropzone border-dashed border-myprimary rounded p-5 text-center">
                                            <div class="dz-message needsclick flex-column text-center gap-5 p-5">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fs-7 fw-semibold text-gray-400">Maks. 10 MB • Rasio 4:3</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-7">
                            <Link href="/admin/pages/letstudy/blogs" type="button" class="btn btn-sm btn-mylighten fs-5 me-3">Batal</Link>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                sub_product_id: props.blog.sub_product_id ?? '',
                title: props.blog.title,
                image: null,
                content: props.blog.content,
                status: props.blog.status,
                is_featured: props.blog.is_featured === 1 || props.blog.is_featured === true
            });
            ...
            onMounted(() => {
                const dz = new Dropzone('#blog-dropzone', {
                    ...
                    init: function () {
                        ...
                        if (props.blog.image) {
                            const mockFile = {
                                name: props.blog.image_name ?? 'Foto Profil',
            ...
            const submit = () => {
                ...
                payload.append('sub_product_id', form.sub_product_id);
                ...
                router.post(`/admin/pages/letstudy/blogs/${props.blog.id}`, payload, {
                    onSuccess: (response) => {
