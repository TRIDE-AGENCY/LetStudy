<template>
    ...
    <Head>
        <title>Edit FAQs − LetStudy</title>
    </Head>
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3 text-muted">Edit FAQs</li>
                        </ol>
                        <div class="page-heading">
                            <h1 class="mb-0">Edit Pertanyaan Umum</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                is_featured: props.faq.is_featured === 1 || props.faq.is_featured === true
            });
            ...
            const submit = () => {
                ...
                router.post(`/admin/pages/letstudy/faqs/${props.faq.id}`, payload, {
                    onSuccess: () => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Data FAQs Berhasil Diperbarui!',
                            timer: 2000,
