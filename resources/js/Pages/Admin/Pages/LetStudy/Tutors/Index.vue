<template>
    ...
    <Head>
        <title>Section Tutor − LetStudy</title>
    </Head>
                    ...
                    <div class="card rounded-4 border border-gray-300">
                        <div class="d-flex flex-grow border-0 p-6 gap-4 flex-column flex-md-row">
                            ...
                            <div class="d-flex gap-4">
                                <Link href="/admin/pages/letstudy/tutors/create" type="button"
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr v-for="(tutor, index) in tutors.data" :key="index">
                                            ...
                                            <td class="text-end pe-6">
                                                <Link :href="`/admin/pages/letstudy/tutors/${tutor.id}/edit`" type="button"
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const handleSearch = () => {
                router.get('/admin/pages/letstudy/tutors', {
                    q: search.value,
                });
            }
            ...
            const destroy = (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(`/admin/pages/letstudy/tutors/${id}`);
                        Swal.fire({
                            icon: 'success',
                            title: 'Dihapus!',
