<template>
    ...
    <Head>
        <title>Section USP − LetStudy</title>
    </Head>
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3 text-muted">USP</li>
                        </ol>
                        <div class="page-heading">
                            <h1 class="mb-0 text-dark">Section Unique Selling Proposition</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="kt_app_content_container" class="app-container container-xxl px-0">
                    <div class="card rounded-4 border border-gray-300">
                            ...
                            <div class="flex-grow-1 ">
                                <form @submit.prevent="handleSearch"
                                    ...
                                    <input type="text" class="form-control form-control-solid ps-13 fs-5"
                                        placeholder="Cari USP disini..." v-model="search" />
                                </form>
                            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="text-center border-top border-bottom border-gray-300 py-10 px-6" v-if="usps.data.length === 0">
                                <img src="/assets/media/illustrations/empty.png"
                                    alt="Tidak ada data" class="mh-225px img-fluid mb-10">
                                <h2 class="text-dark mb-4">USP Tidak Ditemukan</h2>
                                <p class="text-gray-600 fs-4 mb-0">Belum ada USP atau pencarian tidak sesuai.</p>
                            </div>
                            <div class="table-responsive" v-else>
                                <table id="kt_datatable_horizontal_scroll"
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr v-for="(usp, index) in usps.data" :key="index">
                                            <td class="ps-6">
                                                {{ ++index + (usps . current_page - 1) * usps . per_page }}
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center gap-4">
                                                    <img class="w-25px h-25px min-w-25px object-fit-cover"
                                                        :src="`/storage/${usp.icon}`" alt="Icon USP">
                                                    <p class="text-dark fw-bold text-truncate-2 mb-0">
                                                        {{ usp.title }}
                                                    </p>
                                                </div>
                                            </td>
                            ...
                            <Pagination :links="usps.links" align="end" class="py-5 px-6" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card w-100 rounded-0">
                    <div class="card-header ps-6 pe-3 h-60px border-bottom border-gray-300 h-60px h-lg-70px">
                        <div class="card-title">
                            <h2>{{ isEditMode ? 'Edit USP' : 'Tambah USP' }}</h2>
                        </div>
                            ...
                            <div class="card rounded-4 border border-gray-300">
                                ...
                                <div class="card-body p-6">
                                    <div class="mb-5 fv-row">
                                        ...
                                        <div id="usp-dropzone" :key="dropzoneKey"
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" id="kt_drawer_submit_button"
                                ...
                                <span class="indicator-label">
                                    {{ isEditMode ? 'Edit USP' : 'Tambah USP' }}
                                </span>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const handleSearch = () => {
                router.get('/admin/pages/letstudy/usps', {
                    q: search.value,
                });
            }
            ...
            const submit = () => {
                ...
                if (isEditMode.value && editing.value) {
                    ...
                    router.post(`/admin/pages/letstudy/usps/${editing.value.id}`, payload, {
                        onSuccess: () => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil!',
                                text: 'Data USP Berhasil Diperbarui!',
                                timer: 2000,
                    ...
                    router.post('/admin/pages/letstudy/usps', payload, {
                        onSuccess: () => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil!',
                                text: 'Data USP Berhasil Disimpan!',
                                timer: 2000,
                                timerProgressBar: true,
                                showConfirmButton: false,
                                customClass: {
            ...
            const editUSP = (usp) => {
                ...
                form.icon = null;
                form.title = usp.title;
                form.description = usp.description;
            ...
            const destroy = (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(`/admin/pages/letstudy/usps/${id}`);
                        Swal.fire({
                            icon: 'success',
                            title: 'Dihapus!',
                            text: 'Data USP Berhasil Dihapus!',
                            timer: 2000,
                            timerProgressBar: true,
                            showConfirmButton: false,
                            customClass: {
            ...
            watch(dropzoneKey, () => {
                nextTick(() => {
                    const dz = new Dropzone('#usp-dropzone', {
                        url: '/',
                        paramName: 'icon',
                        maxFiles: 1,
                        maxFilesize: 10,
