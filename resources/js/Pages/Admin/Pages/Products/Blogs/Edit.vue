<template>
    ...
    <Head>
        <title>Edit Blog − {{ product.title }}</title>
    </Head>
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            ...
                            <li class="breadcrumb-item pe-3">
                                <Link :href="`/admin/pages/products/${product.slug}/blogs`" class="btn-link-myprimary fw-bold pe-3">Blog</Link>
                            </li>
                ...
                <div id="kt_app_content_container" class="app-container container-xxl px-0">
                    <form @submit.prevent="submit">
                        ...
                        <div class="d-flex justify-content-end mt-7">
                            <Link :href="`/admin/pages/products/${product.slug}/blogs`" type="button" class="btn btn-sm btn-mylighten fs-5 me-3">Batal</Link>
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                router.post(`/admin/pages/products/${props.product.slug}/blogs/${props.blog.id}`, payload, {
                    onSuccess: (response) => {
