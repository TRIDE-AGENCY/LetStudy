<template>
    ...
    <Head>
        <title>Section Blog − {{ product.title }}</title>
    </Head>
                    ...
                    <div class="card rounded-4 border border-gray-300">
                        <div class="d-flex flex-grow border-0 p-6 gap-4 flex-column flex-md-row">
                            ...
                            <div class="d-flex gap-4">
                                <Link :href="`/admin/pages/products/${product.slug}/blogs/create`" type="button"
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr v-for="(blog, index) in blogs.data" :key="index">
                                            ...
                                            <td class="text-end pe-6">
                                                <Link :href="`/admin/pages/products/${product.slug}/blogs/${blog.id}/edit`" type="button"
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const handleSearch = () => {
                router.get(`/admin/pages/products/${props.product.slug}/blogs`, {
                    q: search.value,
                });
            }
            ...
            const destroy = (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(`/admin/pages/products/${props.product.slug}/blogs/${id}`);
                        Swal.fire({
                            icon: 'success',
                            title: 'Dihapus!',
