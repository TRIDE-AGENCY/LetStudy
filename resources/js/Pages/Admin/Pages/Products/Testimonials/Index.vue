<template>
    ...
    <Head>
        <title>Section Testimoni − {{ product.title }}</title>
    </Head>
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="card rounded-4 border border-gray-300 mt-6">
                                <div class="card-header h-auto p-6 border-bottom border-gray-300"
                                    style="min-height: unset;">
                                    <div class="card-title m-0">
                                        <h3 class="required">Testimoni</h3>
                                    </div>
                                </div>
                                <div class="card-body p-6">
                                    <div class="fv-row">
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const handleSearch = () => {
                router.get(`/admin/pages/products/${props.product.slug}/testimonials`, {
                    q: search.value,
                });
            }
            ...
            const submit = () => {
                ...
                if (isEditMode.value && editing.value) {
                    ...
                    router.post(`/admin/pages/products/${props.product.slug}/testimonials/${editing.value.id}`, payload, {
                        onSuccess: () => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil!',
                    ...
                    router.post(`/admin/pages/products/${props.product.slug}/testimonials`, payload, {
                        onSuccess: () => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil!',
            ...
            const destroy = (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(`/admin/pages/products/${props.product.slug}/testimonials/${id}`);
                        Swal.fire({
                            icon: 'success',
                            title: 'Dihapus!',
