        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl px-0">
                    ...
                    <div  v-if="ebooks.data.length > 0" class="d-flex flex-grow gap-4 flex-column flex-sm-row mb-8">
                    ...
                    <div class="row g-6">
                        <div class="text-center py-10" v-if="ebooks.data.length === 0">
                            ...
                            <p class="text-gray-600 fs-4 mb-0">Belum ada e-book yang tersedia. Cek kembali nanti ya!</p>
                        </div>
                        <div v-else v-for="ebook in ebooks.data" :key="ebook.id" class="col-12 col-md-6 col-xxl-4">
                            <div class="card card-hover rounded-4 border border-gray-300 h-100">
                                <Link :href="`/member-area/${product.slug}/${subProduct.slug}/ebooks/${ebook.slug}`" type="button">
