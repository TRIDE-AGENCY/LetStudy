                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <ol class="breadcrumb text-muted fs-6 fw-semibold mb-3">
                            <li class="breadcrumb-item pe-3">
                                <Link :href="`/member-area/${product.slug}/${subProduct.slug}/playlists`" class="btn-link-myprimary fw-bold pe-3">...</Link>
                            </li>
                            <li class="breadcrumb-item pe-3">
                                <Link :href="`/member-area/${product.slug}/${subProduct.slug}/playlists/${playlist.id_playlist}`" class="btn-link-myprimary fw-bold pe-3">Detail Playlist</Link>
                            </li>
