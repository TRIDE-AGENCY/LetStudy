<template>
    <Head>
        <title>Kebijakan Privasi − LetStudy</title>
    </Head>
                    ...
                    <div class="container d-flex flex-column w-100 w-md-700px w-lg-auto">
                        <div class="d-flex flex-column align-items-center text-center py-10 py-md-20">
                            ...
                            <p class="text-center text-gray-600 fs-2 fw-semibold mb-0">
                                Cerita lengkap tentang bagaimana kami <span class="text-myprimary fw-bold">menjaga</span> dan <span class="text-myprimary fw-bold">melindungi</span> data kamu.
                            </p>
                        </div>
                    </div>
                </div>
                <div id="privacy" class="container d-flex flex-column flex-start py-10 py-md-20">
                    <div id="content-editor" class="fs-4" v-html="legal.content"></div>
                </div>
            </div>
